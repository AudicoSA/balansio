  ...
  return (
    <section className="relative overflow-hidden pt-20">
      <div className="grid lg:grid-cols-2 min-h-[90vh]">
        {/* Left Column - Blue Background with Text Content */}
        <div className="relative bg-gradient-to-br from-[#0066FF] to-[#0052CC] px-8 py-16 lg:py-20 lg:px-16 flex items-center">
          <div className="w-full animate-fadeInUp">
            ...
            <button 
              ...
              className="bg-white text-[#0066FF] font-semibold text-lg px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
            >
              Get A Quote
            </button>
        ...
        <div className="relative bg-gray-100 animate-fadeInUp animate-delay-200">
          <Image
            src="/hero.jpg"
